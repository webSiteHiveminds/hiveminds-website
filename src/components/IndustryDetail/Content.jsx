    ...
    <section className='h-full w-screen py-[5vw]' id='industry-detail'>
        <div className='container-lg w-full h-full flex items-start justify-between mobile:flex-col tablet:flex-col'>
            <div className='w-[20%] flex gap-[0.5vw] fadeup mobile:hidden tablet:hidden'>
                <Image src="/assets/images/industry/industry-detail-navigation.svg" height={375} width={15} alt='indutry-detail-navigation' className='mt-[-1vw]'/>
                <div className='flex flex-col items-start gap-[7.5vw]'>
                    <p  className='content'>Overview</p>
                    <p   className='content pt-[2vw]'>Our Approach</p>
                    <p   className='content w-[90%]'>How We Make 
                    a Difference</p>
