  ...
  return (
    ...
    >
      <div className="w-full h-full container-lg flex  justify-between mobile:flex-col mobile:gap-[7vw] tablet:flex-col tablet:gap-[5vw]">
        <div className="mx-auto w-[45%] flex flex-col gap-[1vw] pt-[5vw] mobile:w-full mobile:gap-[4vw] tablet:w-full">
          <h1 className="heading-2 leading-[1.2] w-full headingAnim">
            {title}
          </h1>
          <div className="h-[40vw] relative rounded-[1.2vw] overflow-hidden  mobile:w-full mobile:rounded-[4.5vw] mobile:h-[85vw] tablet:w-full tablet:h-[60vw] tablet:rounded-[3vw]">
            <div className="absolute w-full h-[100%] z-[2] top-0 left-0 overflow-hidden bg-[#f1f1f1] mobile:bg-white1 imgAnim origin-bottom"></div>
            <Image
