...
const LinkButton = ({btnLink, btnText, className= ""}) => {
    return (
        <Link className={`cursor-pointer flex w-fit relative text-[1.1vw] gap-[0.7vw] items-center group mobile:gap-[2vw] tablet:text-[2.5vw] mobile:text-[5vw] ${className} `} href={btnLink}>
            <span className="relative link-line">{btnText}</span>
